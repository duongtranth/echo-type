...
/** Animated or static dot-pattern background used as a subtle texture behind hero sections. */
export function DotPattern({
  ...
  return (
    <svg
      ref={containerRef}
      aria-hidden="true"
      className={cn('pointer-events-none absolute inset-0 h-full w-full text-indigo-300/70', className)}
      {...props}
    >
