  ...
  (
    ...
    return (
      <button
        ...
        className={cn(
          'group relative z-0 flex cursor-pointer items-center justify-center gap-2 overflow-hidden border border-white/10 px-6 py-3 whitespace-nowrap text-white [border-radius:var(--radius)] [background:var(--bg)]',
